          ...
          <p>总销量</p>
			...
			<div class="shop-other-item shop-other-right">
				<div v-for="item in shop.score">
					{{item.name}}&ensp;
					<span class="score" :class="{sActive:item.isBetter}">{{item.score}}</span>
					<span class="score-bg" :class="{sgActive:item.isBetter}">{{item.isBetter? '低' : '高'}}</span>
				</div>
			</div>
		</div>
...
<style  scoped>
  ...
  .shop-other-info .shop-other-right  .sActive{
     ...
     .shop-other-info .shop-other-right .sgActive{
